...
public class SendPushMessages {
    ...
    public SendPushMessages(Message notification) {
    ...
    public void send(List<Device> devices) {
    ...
    private void syncSend(List<String> partialDevices, Message mess) {
        ...
        for (int i = 0; i < devices.size(); i++) {
            ...
            if (messageId != null) {
                LOGGER.log(Level.INFO, "Succesfully sent message to device: " + regId + "; messageId = " + messageId);
